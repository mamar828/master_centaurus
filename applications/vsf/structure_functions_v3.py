...
# gm["LINES.H210_S1.DELTA_V"].save("data/loki/vsf/v3/H210_S1.DELTA_V.fits")
# gm["LINES.H210_S1.TOTAL_SNR"].save("data/loki/vsf/v3/H210_S1.TOTAL_SNR.fits")

velocity = Map.load("data/loki/vsf/v3/H210_S1.DELTA_V.fits")
snr = Map.load("data/loki/vsf/v3/H210_S1.TOTAL_SNR.fits")
